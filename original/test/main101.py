...
if __name__ == "__main__":
    ...
    global_min = min(all_uncertainty)
    global_max = max(all_uncertainty)
    all_uncertainty = [(s - global_min) / (global_max - global_min) if global_max > global_min else 0.0 for s in all_uncertainty]
